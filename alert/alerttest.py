...
#    'battlefront-2-pc-beta':'http://tools.internal.gosredirector.ea.com:42125/redirector/getServerList?name=battlefront-2-pc-beta',
#    'battlefront-2-ps4-beta':'http://tools.internal.gosredirector.ea.com:42125/redirector/getServerList?name=battlefront-2-ps4-beta',
#    'battlefront-2-xone-beta':'http://tools.internal.gosredirector.ea.com:42125/redirector/getServerList?name=battlefront-2-xone-beta'
...
with open('instances3.json') as data_file:
...
#        x = socket.getfqdn(str(int2ip(int(w))))
#        print(x)
    ...
    for y in titledictv2['serverlist']['servers']['serverinfodata']['instances']['serverinstance']:
        ...
        o = ['']
#        print(y.items()[1]['serverendpointinfo'][1]['addresses']['serveraddressinfo']['address']['valu']['ip'])
        o = (y.items()[1])
        print(o[1]['serverendpointinfo'])
#        print("Y ITEMS: ",y.items()[1])
#        print(k[1]['serverendpointinfo'][1]['addresses']['serveraddressinfo']['address']['valu']['ip'])

#        x = socket.getfqdn(str(int2ip(int(k[1]['serverendpointinfo'][1]['addresses']['serveraddressinfo']['address']['valu']['ip']))))
#        print(x)
        lstinstances2.append([str(y.items()[4][1]), str(y.items()[5][1])])
#        z = o[1]['serverendpointinfo'][1]['addresses']['serveraddressinfo']['address']['valu']['ip']
#        h = socket.getfqdn(str(int2ip(int(z))))
#        print(str(y.items()[4][1]),h)
...
if difes.keys():
    with io.open('instances3.json', 'w', encoding='utf8') as outfile:
