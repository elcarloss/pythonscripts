...
if __name__ == "__main__":
    ...
    logpath = "ps -ef | grep logdir|grep -v grep | awk '{ print $23 }'|uniq|grep log"
    os.system('clear')
    print('Processing....................................')
    ...
    if not all([envhost, servicename, command]):
        ...
        plugin_exit(STATUS_CRIT,\
                   'Some parameter is missing, servers.py -e prd -s fifa-2016-ps4', "")
