...
def fetch(uri):
    ''' Fetch a URL '''
    print("El valor de TimeFlag es: ",timeflag)
    try:
...
def get_load(instance,service):
    ...
    print("Has been passed ", timepassed , "seconds")
    if timepassed > timeflag:
       print("Tiempo excedido, terminando script")
       nagios.plugin_exit(nagios.STATUS_CRIT, 'Time excedeed %i' % timepassed)
