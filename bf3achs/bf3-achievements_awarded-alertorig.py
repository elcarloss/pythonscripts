...
GRAPH_URL = ("http://internal.graphite.eu.renderer.gos.gameservices.ea.com/render?target=alias(sumSeries(nonNegativeDerivative(prod.achievements.*.achievements-prod-achievements*.achievements.products.BF_BF3_PC.ACHIEVEMENT_AWARDED.count)),%20%27BF3%20Achievements%20Awarded%27)&from=00%3A00_20170821&until=23%3A59_20170901&format=jso")
...
def get_graph_values(url):
    ...
    """
    print("Entro a la funcion get_graph")
    try:
...
def main():
    ...
    print("Achievement_sum: ", achievement_sum)
