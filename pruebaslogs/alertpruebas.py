...
for x in TITLESALERTS.values():
    ...
    for y in titledictv2['serverlist']['servers']['serverinfodata']['auxmasters']['serverinstance']:
        lstinstances2.append([str(y.items()[4][1]), str(y.items()[5][1]), socket.getfqdn(str(int2ip(int(y.items()[1][1]['serverendpointinfo'][1]['addresses']['serveraddressinfo']['address']['valu']['ip']))))])
...
##MODIFICACION
        ...
        lstinstances2.append([str(y.items()[4][1]), str(y.items()[5][1]), str(g)])
